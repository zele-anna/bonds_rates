...
from db_manager import (
    get_all_data_from_db_table,
    get_filtered_data_from_db_table,
    normalize_trading_data_table,
    save_data_to_db,
)
...
def get_data():
    ...
    save_data_to_db(bonds_data, "bonds")
    ...
    save_data_to_db(trading_data_df, "trading_data")
    ...
    save_data_to_db(macro_df, "macro_data")
...
def calculate_var():
    ...
    for bond in bonds_list:
        ...
        # Проверка на наличие торговых данных и количество выборки
        # Количество данных > 1 для корректной работы формулы, корректнее использовать большую выборку (от 100)
